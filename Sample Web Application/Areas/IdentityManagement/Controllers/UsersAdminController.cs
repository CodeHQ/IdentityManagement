...
using Sample_Web_Application.Areas.IdentityManagement.Filters;
using Sample_Web_Application.Areas.IdentityManagement.Helpers;
using Sample_Web_Application.Areas.IdentityManagement.Models;
using Sample_Web_Application.Models;
using Microsoft.AspNet.Identity.Owin;

namespace Sample_Web_Application.Areas.IdentityManagement.Controllers
{
